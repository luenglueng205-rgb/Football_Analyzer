...
from standalone_workspace.agents.league_profiler_v2 import get_league_persona
...
from standalone_workspace.tools.math.trap_identifier import identify_low_odds_trap
from standalone_workspace.tools.math.latency_arbitrage import detect_latency_arbitrage
from standalone_workspace.tools.math.betfair_anomaly import detect_betfair_anomaly
from standalone_workspace.tools.math.kelly_variance_analyzer import analyze_kelly_variance
import torch
...
def _data_gateway_fetch_match(date: str, lottery_type: str = "JINGCAI"):
    ...
    try:
        from standalone_workspace.core.data_gateway import DataGateway
        gw = DataGateway()
...
def _execute_quant_script(code: str):
    """隔离环境执行量化代码"""
    from standalone_workspace.skills.code_interpreter.server import execute_quant_script
