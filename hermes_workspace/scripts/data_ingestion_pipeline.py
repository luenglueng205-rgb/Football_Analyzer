...
import time
import argparse
from hermes_workspace.tools.paths import data_dir, HISTORICAL_DATA_FILENAME, datasets_dir

# Setup paths
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(PROJECT_ROOT)

from hermes_workspace.tools.memory_manager import MemoryManager
