...
from hermes_workspace.agents.league_profiler_v2 import get_league_persona
...
def _data_gateway_fetch_match(date: str, lottery_type: str = "JINGCAI"):
    ...
    try:
        from hermes_workspace.core.data_gateway import DataGateway
        gw = DataGateway()
...
def _execute_quant_script(code: str):
    """隔离环境执行量化代码"""
    from hermes_workspace.skills.code_interpreter.server import execute_quant_script
